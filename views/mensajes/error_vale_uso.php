   ...
   <body>
       ...
       <div id="error-container">
           <div class="error-options">
               ...
               switch ($rol) {
               case '1':
                  echo '<a href="../app/solicitarServicio">Regresar</a></h3>';
                 break;
                 case '2':
                    echo '<a href="../app/solicitarServicio">Regresar</a></h3>';
                   break;
           ...
           <div class="row">
               <div class="col-sm-8 col-sm-offset-2 text-center">
                   <h1 class="animation-pulse"><i class="fa fa-cab text-warning"></i></h1>
                   <h2 class="h3">¡ERROR! <br>Lo sentimos, El vale esta siendo utilizado en un servicio.</h2>
