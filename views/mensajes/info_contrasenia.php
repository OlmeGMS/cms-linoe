    ...
    <body>
        ...
        <div id="error-container">
            <div class="error-options">
                <h3><i class="fa fa-chevron-circle-left text-muted"></i> <a href="../../index.html">Regresar</a></h3>
            </div>
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 text-center">
                    <h1 class="animation-pulse"><i class="fa fa-info text-info"></i></h1>
                    <h2 class="h3">Apreciad@ <?php echo $nombre ?></h2> 
                      <h4 class="h3" style="color: #ffffff;">TaxisYa le ha enviado a su correo una clave temporal para que pueda acceder al sistema.</h4>
                </div>
            </div>
        </div>
        <!-- END Error Container -->
