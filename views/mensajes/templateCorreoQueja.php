...
function EmailTemplateRespuesta($respuesta, $queja, $nombre,$fecha) {
          ...
          <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 600px;" class="content">
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" width="100%">
                          <tr>
                              <td align="center" style="color: #aaaaaa; font-family: Arial, sans-serif; font-size: 12px;">
                                  Sí no puede ver este correo electronico?  <a href="#" style="color: #043e50;">Mira tu explordor o abrelo en otro.</a>
                              </td>
                          </tr>
                      </table>
                  </td>
              ...
              <tr>
                  <td align="center" bgcolor="#ffffff" style="padding: 40px 20px 40px 20px; color: #555555; font-family: Arial, sans-serif; font-size: 20px; line-height: 30px; border-bottom: 1px solid #f6f6f6;">
                      <b>Apreciad@ '.$nombre.', </b><br/>
                      Segun la inquietud: <b>"'.$queja.'"</b> registrada el '.$fecha.'.<br/>
                      Tiene la siguiente respuesta:.<br/>
                      <b>'.$respuesta.'</b><br/>
                      Para Taxisya nuestra prioridad es prestar el mejor servicio.<br/>
