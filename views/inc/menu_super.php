                ...
                <div id="sidebar-scroll">
                  ...
                  <!-- END User Info -->
                        ...
                        <ul class="sidebar-nav">
                          ...
                          <ul>
                            <li>
                                <a href="javascript:void(0)"><i class="fa fa-list sidebar-nav-icon "></i>Serivicios por estados</span></a>
                            </li>
                            <li>
                                <a href="javascript:void(0)"><i class="fa fa-plus sidebar-nav-icon "></i>Solicitar Servicio</span></a>
                            </li>
                            <li>
                                <a href="serviciosActivos"><i class="fa fa-bars sidebar-nav-icon "></i>Servicios Activos</span></a>
                            </li>
                            <li>
                                <a href="javascript:void(0)"><i class="fa fa-calendar sidebar-nav-icon "></i>Agendar Servicio</span></a>
                            </li>
                            <li>
                                <a href="javascript:void(0)"><i class="fa fa-print sidebar-nav-icon "></i>Reporte Servicio</span></a>
                            </li>
                          </ul>
                          ...
                          <ul>
                            <li>
                                <a href="javascript:void(0)"><i class="fa fa-tablet sidebar-nav-icon "></i>Notificaciones</span></a>
                            </li>
                            <li>
                                <a href=".javascript:void(0)"><i class="fa fa-hand-o-right sidebar-nav-icon "></i>Quejas y Reclamos</span></a>
                            </li>
                          </ul>
                        </ul>
