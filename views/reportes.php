                    ...
                    <div id="page-content">
                        ...
                        <div class="content-header">
                            <div class="header-section">
                                <h1>
                                    <i class="gi gi-brush"></i>Reportes<br><small>Complete el siquiente formulario para descargar los reportes!</small>
                                </h1>
                            </div>
                        </div>
                        ...
                        <div class="block">
                            ...
                            <!-- Example Content -->
                            <form id="form-empresa" action="../controllers/reporteSecretariaController.php" method="post" class="form-horizontal form-bordered">
                              <fieldset>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-6">
                                    <select id="empresa" name="empresa" class="select-chosen" data-placeholder="Seleccione el país de la empresa" style="width: 250px;">-->
                                    <!--<select type="text" class="form-control" name="pais" id="pais">-->
                                      <option value=""disabled selected>Seleccione la empresa</option>
                                      <?php echo listaEmpresasAfiliadasAppFacade(); ?>
                                    </select>
                                  </div>
                                </div>
                                ...
                                <div class="form-group ">
                                  <div class="col-md-8 col-md-offset-4">
                                    <button href="" type="submit" class="btn btn-sm btn-success" id="btn-consultar"><i class="fa fa-arrow-right"></i> Consultar</button>
