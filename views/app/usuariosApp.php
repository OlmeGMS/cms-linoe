...
$link = '<a href="crearUsuarioApp.php"><i class="fa fa-plus"></i>Crear Nuevo Usuario</a>';
?>
<!-- Page content -->
<div id="page-content">
    ...
    <div class="block full">
        ...
        <div class="block-title">
          <!--  <div class="block-options pull-right">
            ...
            <h2><strong>Todos</strong> Los Usuarios Apps</h2> <?php if($rol == 1 || $rol == 2){ echo $link;} ?>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" onclick="$('#modal-search-user').modal('show');" id="btn-search-user"><i class="fa fa-search"></i>Busqueda personalizada</a>
