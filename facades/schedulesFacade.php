...
function tablaAgendamientoBuscadorFacade($arg_campo, $arg_frase){
  $consulta = new Services();
  $consultaUsers = new Users();
  $consultaAgendamiento = new Schedule();
  ...
  $js = "$('#modal-services').modal('show');";
  $filas = $consultaAgendamiento->buscarAgendamiento($campo, $item);
