...
$fecha2 = $_GET['fecha2'];
if($ts == 1){
  $filas = $consulta->reporteServicioTodoFinalizados($fecha1, $fecha2);
}else{
      ...
      <table id="table-usuarios" class="table table-bordered table-striped table-vcenter">
          <thead>
              <tr>
                  ...
                  <th class="text-center">Id Conductor</th>
